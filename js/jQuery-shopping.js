								...
								$obj.stop(false, false).animate({'top': Y-20,'opacity':0},500,function(){
									$obj.fadeOut(300,function(){
										...
										var l=$('.J-shoping-list').length,
											num=Number($num.text());
										if(l<5){
											$body.prepend('<div class="J-shoping-list" data-id="'+id+'"><a href="#"title="">天梭系列<img src="images/pro1.jpg" width="50"height="50"/></a><div class="J-shoping-list-a"><p>TDC51D+AZ</p><p><span class="left"></span><span class="right"></span></p></div><div class="baseBg J-shoping-close"></div></div>');
										};
										$num.text(num+1);
									});
								});
